    ...
    <header className="text-white bg-[#141414] body-font">
      <div className="container mx-auto flex flex-wrap py-5 flex-col md:flex-row items-center">
        ...
        <nav className="md:mr-auto md:ml-4 md:py-1 md:pl-4 flex flex-wrap items-center text-base justify-center">
          ...
          <a href='/book-notes' className="mr-5 hover:text-gray-300 hover:scale-110">Book Notes</a> {/* New Button */}
        </nav>
        <div className='flex gap-5'>
          ...
          <a href="https://calendly.com/pranav-7ge/30min?back=1&month=2023-08" target="_blank" rel="noopener noreferrer">
