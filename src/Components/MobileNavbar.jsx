...
const MobileNavbar = () => {
  ...
  return (
    <>
         <nav className="flex items-center justify-between px-4 py-3 sticky top-0 z-40 bg-[#101010]">
  ...
  <div className="z-40 p-4 h-screen overflow-y-auto w-96 text-white">
    ...
    <div className="py-2 gap-10 overflow-y-auto flex-col flex justify-center items-center h-full">
      ...
      <ul onClick={toggleDrawer} className="space-y-6 font-bold text-center text-xl">
        <li>
        <a href='/#about' className="mr-5 hover:text-gray-300 hover:scale-110 text-center">About me</a>

        </li>
        <li>
        <a href='/#portfolio' className="mr-5 hover:text-gray-300 hover:scale-110 text-center">Portfolio</a>

          
        </li>
        <li>
        <a href='/#skills' className="mr-5 hover:text-gray-300 hover:scale-110 text-center">Skils</a>

        </li>
        <li>
        <a href='/#milestone' className="mr-5 hover:text-gray-300 hover:scale-110 text-center">Milestone</a>

        </li>
        <li>
        <a href='/#connect' className="mr-5 hover:text-gray-300 hover:scale-110 text-center">Connect</a>
